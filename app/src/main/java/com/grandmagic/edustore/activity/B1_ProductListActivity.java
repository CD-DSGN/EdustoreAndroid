...
import com.grandmagic.edustore.adapter.B1_ProductListAdapter;
       ...
       final LinearLayout mainView = (LinearLayout) findViewById(R.id.keyboardLayout1);
        ...
        if (null != filter_string)
        {
            try
            {
                ...
                filter =new com.grandmagic.edustore.protocol.FILTER();
            ...
            case 1:
            {
                if(null != data)
                {
                    ...
                    if (null != filter_string)
                    {
                        ...
                        {
                            JSONObject filterJSONObject = new JSONObject(filter_string);
                            FILTER filter = new com.grandmagic.edustore.protocol.FILTER();
                            filter.fromJson(filterJSONObject);
